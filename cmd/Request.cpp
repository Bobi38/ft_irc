...
Request::Request(const std::string& str_init): _Clt(Client(str_init)){
	if (str_init.empty())
		return ;
...
Request::Request(const std::string& str_init, const Client& Clt): _Clt(Clt){
	if (str_init.empty())
		return ;
...
Request::Request(const Request& other) 
	: _Clt(other._Clt), _msg(other._msg), _tabSize(other._tabSize)
{
